...
class DMTextField extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return DMTextFieldState();
  }
}

class DMTextFieldState extends State<DMTextField> {
    ...
    if (widget.isValidate) {
      setState(() {
        if (widget.controller.text.isEmpty) {
          _isValidate = false;
          _errMess = Utils.getString(context, txt_empty_text_field);
  ...
  getBorderDecor() {
    if (_isFirstTime) {
      ...
      if (_isFocus) {
        return Border.all(color: start_gradient_color);
      } else {
        if (widget.isValidate) {
          if (!_isValidate) {
            return Border.all(color: start_gradient_color);
